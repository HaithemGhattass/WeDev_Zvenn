...
class ProduitsController extends AbstractController
{
    /**
     * @return Response
     * @Route ("user/produits",name="produits")
     */
    function Affiche( ){
     ...
     * @return Response
     * @Route ("/vendeur/ajoutproduits/{id}",name="ajouterproduits")
     */
    function AjouterProduit(Request $request, RestaurantRepository$repository,$id ): Response
    {
        ...
        return $this->render('Frontend/produits/ajoutproduits.html.twig',
            [
                'produits' => $produits,
     ...
     * @Route ("vendeur/deleteproduit/{id}",name="deleteproduit")
     */
    ...
    /**
     * @Route("vendeur/updateproduit/{id}",name="updateproduit")
     */
    function Update(ProduitsRepository $repository,$id,Request $request)
    {
        ...
        return $this->render('Frontend/produits/updateproduit.html.twig',
            [
                'form' => $form->createView()
            ]);
    }
